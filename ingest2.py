...
def load_single_document(file_path: str) -> Document:
    ...
    try:
        ...
        if loader_class:
            ...
            # Normalize and tokenize the content for Persian language
            # normalizer = Normalizer()
            # content = normalizer.normalize(content)
            # Tokenize the text using the WordTokenizer from the hazm library
...
def split_documents(documents: list[Document]) -> tuple[list[Document], list[Document], list[Document]]:
    ...
    for doc in documents:
        if doc is not None:
            ...
            # elif is_persian(doc.page_content):  # Check if the content is in Persian language
            #     persian_docs.append(doc)
            else:
...
def main(device_type):
    ...
    chunk_size = 2000  # int(avg_doc_length/5) if avg_doc_length > 10000 else 2000  # Adjust this value as needed
    chunk_overlap = 100  # int(chunk_size * 0.1)  # Adjust this value as needed
